import { QuotesIcon as Quote } from "@phosphor-icons/react/ssr";
    ...
    <section className="section-padding container grid min-h-screen max-w-3xl place-items-center">
      <div>
            ...
            <div className="flex h-full flex-col justify-between p-8">
              ...
              <div className="space-y-4">
                ...
                <blockquote className="mt-0.5 text-lg font-medium">
                  We cut our median deploy time from 18 minutes to under four. Preview environments on every PR changed
                  how we review changes.
                </blockquote>

                <figure className="flex items-center gap-4">
                  <Image
                    src="https://images.unsplash.com/photo-1543610892-0b1f7e6d8ac1?w=200&h=200&fit=crop&crop=faces&q=80"
                    alt="Maya Chen"
                    width={32}
                    height={32}
                  ...
                  />
                  <figcaption>
                    <cite className="block text-xs font-bold not-italic">Maya Chen</cite>
                    <p className="text-[0.625rem]">Platform Engineer, Northline Systems</p>
                  </figcaption>
                </figure>
              </div>
            </div>
        ...
        <div className="text-muted-foreground mx-auto mt-8 max-w-md text-center text-xs">
          By continuing, you agree to Relay&apos;s Terms of Service and Privacy Policy, and to receive periodic emails
...
const GradientSVG = (props: React.SVGProps<SVGSVGElement>) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={327} height={303} fill="none" {...props}>
      <path fill="#D9D9D9" d="M-71.305 280.86-150.61 96.276-95.707-8.827 62.906 26.207l51.767 93.077L-71.305 280.86Z" />
      <path fill="url(#a)" d="M-71.305 280.86-150.61 96.276-95.707-8.827 62.906 26.207l51.767 93.077L-71.305 280.86Z" />
      <path
        stroke="url(#b)"
        strokeWidth={0.3}
      ...
      />
      <g filter="url(#e)">
        <path fill="url(#f)" d="m173.621 215.759 78.174-268.327 2.211 154.951-80.385 113.376Z" />
      </g>
      <defs>
        <linearGradient id="a" x1={-17.969} x2={-17.766} y1={-8.827} y2={281.018} gradientUnits="userSpaceOnUse">
          <stop offset={0} stopColor="#6EE7B7" />
          <stop offset={0.516} stopColor="#10B981" />
        </linearGradient>
        <linearGradient id="b" x1={-17.969} x2={-17.969} y1={-8.827} y2={280.86} gradientUnits="userSpaceOnUse">
          <stop stopColor="#99F6E4" />
          <stop offset={1} stopColor="#99F6E4" stopOpacity={0} />
        </linearGradient>
        <linearGradient id="c" x1={168.309} x2={318.523} y1={206.201} y2={206.258} gradientUnits="userSpaceOnUse">
          <stop stopColor="#059669" />
          <stop offset={0.514} stopColor="#14B8A6" />
          <stop offset={1} stopColor="#84CC16" />
        </linearGradient>
        <linearGradient id="d" x1={75.661} x2={75.842} y1={-38.308} y2={292.574} gradientUnits="userSpaceOnUse">
          <stop stopColor="#2DD4BF" />
          <stop offset={1} stopColor="#34D399" />
        </linearGradient>
        <linearGradient id="f" x1={238.974} x2={140.96} y1={29.317} y2={159.747} gradientUnits="userSpaceOnUse">
          <stop stopColor="#4ADE80" />
          <stop offset={0.505} stopColor="#A3E635" />
        ...
        >
          ...
          <feGaussianBlur result="effect1_foregroundBlur_434_3989" stdDeviation={7.068} />
        </filter>
      </defs>
    </svg>
  );
