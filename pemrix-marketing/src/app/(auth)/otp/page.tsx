"use client";
import { CaretLeftIcon as ChevronLeft, CopyIcon as Copy } from "@phosphor-icons/react";
  ...
  return (
    <>
      ...
      <div className="mt-6 space-y-1">
        <h1 className="text-card-foreground text-xl font-semibold">Verify your email</h1>
        <p className="text-xs">Enter the 6-digit code we sent to your email to finish signing in.</p>
      </div>
