...
import { EyeIcon as Eye, EyeSlashIcon as EyeClosed } from "@phosphor-icons/react";
  ...
  return (
    <>
      <div className="space-y-1">
        <h1 className="text-card-foreground text-xl font-semibold">Start shipping in minutes</h1>
        <p className="text-xs">Create a Relay account to run pipelines and preview every PR.</p>
      </div>
      ...
      <div className="mt-6 text-xs">
        ...
        <Link href="/signin" className="text-chart-1 font-bold hover:underline">
          Sign in
        </Link>
      </div>
    </>
