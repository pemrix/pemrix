...
seoTitle: 'Provider Integration | Add Your AI Models to OpenRouter'
og:site_name: OpenRouter Documentation
og:title: 'Provider Integration - Add Your Models to OpenRouter'
og:description: "Learn how to integrate your AI models with OpenRouter. Complete guide for providers to make their models available through OpenRouter's unified API."
og:image: https://openrouter.ai/dynamic-og?title=Provider%20Integration&description=Add%20Your%20Models%20to%20OpenRouter
og:image:width: 1200
og:image:height: 630
...
<Note>
  ...
  [legacy flat format](/guides/community/for-providers-legacy) remains supported for existing
  integrations.
</Note>
...
<Note>
  The [previous flat model document format](/guides/community/for-providers-legacy) (a flat
...
```json title="document root" lines
{
  "capacity": [
    { "type": "request", "unit": "request", "per": "minute", "value": 1000 }
  ]
...
[Download the provider schema (OpenAPI 3.1 JSON)](/assets/provider-monitor-schema-v2.openapi.json)
