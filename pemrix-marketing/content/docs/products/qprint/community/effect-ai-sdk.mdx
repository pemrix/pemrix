---
title: Effect AI SDK
description: Integrate OpenRouter using the Effect AI SDK
seoTitle: 'Effect AI SDK Integration | OpenRouter SDK Support'
og:site_name: OpenRouter Documentation
og:title: 'Effect AI SDK Integration - OpenRouter SDK Support'
og:description: 'Integrate OpenRouter using the Effect AI SDK. Complete guide for integrating the Effect AI SDK with OpenRouter.'
og:image: https://openrouter.ai/dynamic-og?title=Effect%20AI%20SDK&description=Effect%20AI%20SDK%20Integration
og:image:width: 1200
og:image:height: 630
