...
description: A unified API for calling any LLM with automatic tool execution and multiple consumption patterns
seoTitle: 'Call Model Overview (Typescript) | OpenRouter SDK'
...
og:image: https://openrouter.ai/dynamic-og?title=Call%20Model%20Overview%20(Typescript)&description=Unified%20LLM%20API%20with%20Tools
og:image:width: 1200
og:image:height: 630
...
- **[Lifecycle Hooks](/agent-sdk/call-model/lifecycle-hooks)** - Observe and
