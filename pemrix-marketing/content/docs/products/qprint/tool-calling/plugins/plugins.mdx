---
title: Plugins
description: Extend model capabilities with OpenRouter plugins
seoTitle: 'Plugins | Extend AI Model Capabilities'
og:site_name: OpenRouter Documentation
og:title: 'Plugins - Extend AI Model Capabilities'
og:description: "Enable powerful plugins like web search, PDF processing, and response healing to extend any model's capabilities on OpenRouter."
og:image: https://openrouter.ai/dynamic-og?title=Plugins&description=Extend%20AI%20Model%20Capabilities
og:image:width: 1200
og:image:height: 630
