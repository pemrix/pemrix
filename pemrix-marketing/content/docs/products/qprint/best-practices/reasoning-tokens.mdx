...
seoTitle: 'Reasoning Tokens | Enhanced AI Model Reasoning with OpenRouter'
og:site_name: OpenRouter Documentation
og:title: 'Reasoning Tokens - Improve AI Model Decision Making'
og:description: 'Learn how to use reasoning tokens to enhance AI model outputs. Implement step-by-step reasoning traces for better decision making and transparency.'
og:image: https://openrouter.ai/dynamic-og?title=Reasoning%20Tokens&description=Enhance%20AI%20model%20outputs%20with%20OpenRouter
og:image:width: 1200
og:image:height: 630
...
- `"effort": "max"` - Allocates the largest portion of tokens for reasoning (approximately 95% of max_tokens)
- `"effort": "xhigh"` - Same allocation as max (approximately 95% of max_tokens)
...
```python title="Python (OpenAI SDK)" expandable lines
...
<span id="preserving-reasoning-blocks"></span>
...
<span id="reasoning-context"></span>
...
<span id="responses-api-shape"></span>
