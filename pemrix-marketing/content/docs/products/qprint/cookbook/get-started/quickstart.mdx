---
title: "Quickstart: Build a Chat App"
description: Send your first message and stream a response with the OpenRouter SDK
seoTitle: 'Quickstart: Build a Chat App | OpenRouter Cookbook'
og:site_name: OpenRouter Documentation
og:title: 'Quickstart: Build a Chat App with OpenRouter'
og:description: 'Build a working chat app in TypeScript that streams responses from any model on OpenRouter. Install the SDK, send a message, and handle multi-turn conversations.'
og:image: https://openrouter.ai/dynamic-og?title=Quickstart%3A%20Build%20a%20Chat%20App&description=Stream%20responses%20from%20any%20model%20on%20OpenRouter
og:image:width: 1200
og:image:height: 630
...
Text now prints incrementally. See the [Streaming reference](/api_reference/streaming)
