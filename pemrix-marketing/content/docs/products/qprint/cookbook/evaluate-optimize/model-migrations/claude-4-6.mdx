...
description: Migrate to Claude 4.6 with adaptive thinking and max effort level
seoTitle: 'Claude 4.6 Migration Guide | OpenRouter'
...
og:image: https://openrouter.ai/dynamic-og?title=Claude%204.6%20Migration%20Guide&description=Adaptive%20thinking%20and%20max%20effort%20level
og:image:width: 1200
og:image:height: 630
