...
description: Select an OpenRouter video model by matching clip requirements and scoring priorities
seoTitle: 'Choose a Video Generation Model | OpenRouter Cookbook'
og:site_name: OpenRouter Documentation
og:title: 'Choose a Video Generation Model - OpenRouter Cookbook'
og:description: 'Fetch OpenRouter video model metadata, filter by capability, and score models by speed, cost, and quality priorities before submitting a video job.'
og:image: https://openrouter.ai/dynamic-og?title=Choose%20a%20Video%20Generation%20Model&description=Filter%20OpenRouter%20video%20models%20by%20capability
og:image:width: 1200
og:image:height: 630
