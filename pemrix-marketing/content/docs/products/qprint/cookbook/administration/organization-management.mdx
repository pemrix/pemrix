...
description: Manage teams and shared resources with OpenRouter organizations
seoTitle: 'OpenRouter Organization Management | Developer Documentation'
og:site_name: OpenRouter Documentation
og:title: 'OpenRouter Organization Management'
og:description: "Learn how to create and manage organizations on OpenRouter for team collaboration, shared credits, and centralized API management."
og:image: https://openrouter.ai/dynamic-og?pathname=use-cases/organization-management&title=Organization%20Management&description=Team%20collaboration%20and%20shared%20resources
og:image:width: 1200
og:image:height: 630
...
<AccordionGroup>
  <Accordion title="Can I convert my personal account to an organization?">
    No, organizations are separate entities. You'll need to create a new organization and transfer resources as needed. Contact support@openrouter.ai for assistance with credit transfers.
  </Accordion>
