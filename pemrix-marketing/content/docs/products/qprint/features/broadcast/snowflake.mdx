---
title: Snowflake
description: Send traces to Snowflake
seoTitle: 'Broadcast to Snowflake | OpenRouter Observability'
og:site_name: OpenRouter Documentation
og:title: 'Broadcast to Snowflake - Send Traces to Your Data Warehouse'
og:description: 'Connect Snowflake to automatically receive traces from your OpenRouter requests. Step-by-step setup guide for Snowflake integration.'
og:image: https://openrouter.ai/dynamic-og?title=Snowflake%20Broadcast&description=Send%20traces%20to%20Snowflake
og:image:width: 1200
og:image:height: 630
...
<Frame>
<img alt="Snowflake Table Setup" src="/assets/guides/features/broadcast/snowflake/snowflake-table-setup.png" />
</Frame>
...
<Frame>
<img alt="Snowflake PAT" src="/assets/guides/features/broadcast/snowflake/snowflake-pat.png" />
</Frame>
...
<Frame>
<img alt="Snowflake Test Trace" src="/assets/guides/features/broadcast/snowflake/snowflake-test-trace.png" />
</Frame>
