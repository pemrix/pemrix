---
title: ClickHouse
description: Send traces to ClickHouse
seoTitle: 'Broadcast to ClickHouse | OpenRouter Observability'
og:site_name: OpenRouter Documentation
og:title: 'Broadcast to ClickHouse - Send Traces to Your Analytics Database'
og:description: 'Connect ClickHouse to automatically receive traces from your OpenRouter requests. Step-by-step setup guide for ClickHouse integration.'
og:image: https://openrouter.ai/dynamic-og?title=ClickHouse%20Broadcast&description=Send%20traces%20to%20ClickHouse
og:image:width: 1200
og:image:height: 630
...
<Frame>
<img alt="ClickHouse Setup Instructions" src="/assets/guides/features/broadcast/clickhouse/broadcast-clickhouse-setup.png" />
</Frame>
...
<Frame>
<img alt="ClickHouse Configuration" src="/assets/guides/features/broadcast/clickhouse/broadcast-clickhouse-config.png" />
</Frame>
