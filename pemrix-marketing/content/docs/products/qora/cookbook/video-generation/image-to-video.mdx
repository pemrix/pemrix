...
description: Use frame images to control the first or last frame of an OpenRouter video
seoTitle: 'Turn an Image into a Video | OpenRouter Cookbook'
og:site_name: OpenRouter Documentation
og:title: 'Turn an Image into a Video - OpenRouter Cookbook'
og:description: 'Submit an OpenRouter image-to-video job with frame_images, poll for completion, and download the finished clip.'
og:image: https://openrouter.ai/dynamic-og?title=Turn%20an%20Image%20into%20a%20Video&description=Use%20frame%20images%20with%20OpenRouter%20video%20generation
og:image:width: 1200
og:image:height: 630
