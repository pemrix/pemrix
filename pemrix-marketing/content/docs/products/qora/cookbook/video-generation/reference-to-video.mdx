---
title: Guide a Video with Reference Images
description: Use reference images to influence video subject, style, or identity without exact frame control
seoTitle: 'Guide a Video with Reference Images | OpenRouter Cookbook'
og:site_name: OpenRouter Documentation
og:title: 'Guide a Video with Reference Images - OpenRouter Cookbook'
og:description: 'Submit an OpenRouter reference-to-video job with input_references when images should guide the generated result.'
og:image: https://openrouter.ai/dynamic-og?title=Guide%20a%20Video%20with%20Reference%20Images&description=Use%20input%20references%20with%20OpenRouter%20video%20generation
og:image:width: 1200
og:image:height: 630
