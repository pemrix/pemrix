---
title: "OpenClaw 🦞"
description: Use OpenClaw (formerly Moltbot, formerly Clawdbot) with OpenRouter
seoTitle: 'Integration with OpenClaw | OpenRouter'
og:site_name: OpenRouter Documentation
og:title: 'OpenClaw Integration - OpenRouter'
og:description: 'Learn how to configure OpenClaw to use OpenRouter for AI agents across multiple messaging platforms.'
og:image: https://openrouter.ai/dynamic-og?title=OpenClaw&description=Use%20OpenClaw%20with%20OpenRouter
og:image:width: 1200
og:image:height: 630
