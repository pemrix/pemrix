...
description: Use Claude Desktop with OpenRouter
seoTitle: 'Claude Desktop Integration | OpenRouter'
og:site_name: OpenRouter Documentation
og:title: 'Claude Desktop Integration - OpenRouter'
og:description: 'Learn how to use Claude Desktop with OpenRouter through built-in third-party inference mode.'
og:image: https://openrouter.ai/dynamic-og?title=Claude%20Desktop&description=Use%20Claude%20Desktop%20with%20OpenRouter
og:image:width: 1200
og:image:height: 630
...
<Frame>
<img alt="Claude Desktop Help menu showing Troubleshooting submenu with Enable Developer Mode highlighted" src="/assets/cookbook/coding-agents/claude-desktop-integration/claude-desktop-enable-developer-mode.png" />
</Frame>
...
<Frame>
<img alt="Claude Desktop Developer menu with Configure Third-Party Inference highlighted" src="/assets/cookbook/coding-agents/claude-desktop-integration/claude-desktop-configure-third-party.png" />
</Frame>
...
<Frame>
<img alt="Claude Desktop third-party inference configuration panel showing Gateway selected with OpenRouter credentials" src="/assets/cookbook/coding-agents/claude-desktop-integration/claude-desktop-gateway-credentials.png" />
</Frame>
