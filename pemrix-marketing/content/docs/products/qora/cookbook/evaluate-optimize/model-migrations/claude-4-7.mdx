---
title: Claude 4.7 Migration Guide
description: Migrate to Claude 4.7 Opus — sampling parameters removed, adaptive-only thinking, and new xhigh effort level
seoTitle: 'Claude 4.7 Migration Guide | OpenRouter'
og:site_name: OpenRouter Documentation
og:title: 'Claude 4.7 Migration Guide'
og:description: 'Learn about the breaking changes in Claude 4.7 Opus — removed sampling parameters, adaptive-only thinking, and the new xhigh effort level.'
og:image: https://openrouter.ai/dynamic-og?title=Claude%204.7%20Migration%20Guide&description=Removed%20sampling%20parameters%2C%20adaptive-only%20thinking%2C%20and%20xhigh%20effort
og:image:width: 1200
og:image:height: 630
