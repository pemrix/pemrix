---
title: Claude 5 Sonnet Migration Guide
description: Migrate to Claude 5 Sonnet — sampling parameters removed, adaptive-only thinking, and the new xhigh effort level
seoTitle: 'Claude 5 Sonnet Migration Guide | OpenRouter'
og:site_name: OpenRouter Documentation
og:title: 'Claude 5 Sonnet Migration Guide'
og:description: 'Learn about the breaking changes in Claude 5 Sonnet — removed sampling parameters, adaptive-only thinking, the new xhigh effort level, and real-time cyber safeguards.'
og:image: https://openrouter.ai/dynamic-og?title=Claude%205%20Sonnet%20Migration%20Guide&description=Removed%20sampling%20parameters%2C%20adaptive-only%20thinking%2C%20and%20xhigh%20effort
og:image:width: 1200
og:image:height: 630
...
Reasoning is [on by default](https://platform.claude.com/docs/en/about-claude/models/whats-new-sonnet-5#adaptive-thinking-on-by-default) on Sonnet 5: requests that don't configure [`reasoning`](/guides/best-practices/reasoning-tokens) run with adaptive thinking enabled. Disable it explicitly with `reasoning: { "enabled": false }` if your integration assumes non-reasoning responses.
