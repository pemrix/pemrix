---
title: Pareto Router
description: Pick a coding model by minimum coding score without choosing a specific model
seoTitle: 'Pareto Router | Coding-Score-Based Model Selection'
og:site_name: OpenRouter Documentation
og:title: 'Pareto Router - Coding-Score-Based Model Selection'
og:description: "Route coding requests by a single minimum coding score using OpenRouter's Pareto Router."
og:image: https://openrouter.ai/dynamic-og?title=Pareto%20Router&description=Coding-score-based%20model%20selection
og:image:width: 1200
og:image:height: 630
