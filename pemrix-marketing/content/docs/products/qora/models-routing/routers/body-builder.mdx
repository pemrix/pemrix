---
title: Body Builder
description: Generate multiple parallel API requests from natural language
seoTitle: 'Body Builder | Multi-Model Request Generation'
og:site_name: OpenRouter Documentation
og:title: 'Body Builder - Generate Parallel API Requests'
og:description: "Use natural language to generate multiple OpenRouter API requests for parallel model execution."
og:image: https://openrouter.ai/dynamic-og?title=Body%20Builder&description=Multi-model%20request%20generation
og:image:width: 1200
og:image:height: 630
