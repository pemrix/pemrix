---
title: Advisor
description: Consult a stronger model mid-generation as a server tool
seoTitle: 'Advisor Server Tool | Mid-generation Model Consultation on OpenRouter'
og:site_name: OpenRouter Documentation
og:title: 'Advisor Server Tool - Consult a Stronger Model Mid-generation'
og:description: 'Let a fast executor model consult a higher-intelligence advisor model for guidance mid-generation, with any OpenRouter model.'
og:image: https://openrouter.ai/dynamic-og?title=Advisor%20Server%20Tool&description=Consult%20a%20stronger%20model%20on%20demand
og:image:width: 1200
og:image:height: 630
...
- **At most one entry may omit `name`**. It becomes the default advisor. Two or more unnamed advisor entries fail the request with a `400`: _"Only one advisor tool can serve as the default. All other advisor tools must have a name defined."_
...
<Note>
**tool_choice and named advisors**
