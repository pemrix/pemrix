---
title: Web Fetch
description: Give any model the ability to fetch content from URLs
seoTitle: 'Web Fetch Server Tool | URL Content Retrieval for Any Model'
og:site_name: OpenRouter Documentation
og:title: 'Web Fetch Server Tool - URL Content Retrieval for Any Model'
og:description: 'Add URL content fetching to any model on OpenRouter. The model decides when to fetch, OpenRouter retrieves the content, and results are returned as text.'
og:image: https://openrouter.ai/dynamic-og?title=Web%20Fetch%20Server%20Tool&description=URL%20content%20retrieval%20for%20any%20model
og:image:width: 1200
og:image:height: 630
