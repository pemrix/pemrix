---
title: Arize AX
description: Using OpenRouter with Arize AX
seoTitle: 'Arize AX Integration | OpenRouter SDK Support'
og:site_name: OpenRouter Documentation
og:title: 'Arize AX Integration - OpenRouter SDK Support'
og:description: 'Integrate OpenRouter using Arize AX for observability and tracing. Complete guide for Arize AX integration with OpenRouter for Python and JavaScript applications.'
og:image: https://openrouter.ai/dynamic-og?title=Arize%20AX&description=Arize%20AX%20Integration
og:image:width: 1200
og:image:height: 630
