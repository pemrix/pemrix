---
title: Raindrop
description: Send traces to Raindrop
seoTitle: 'Broadcast to Raindrop | OpenRouter Observability'
og:site_name: OpenRouter Documentation
og:title: 'Broadcast to Raindrop - Send Traces to Raindrop'
og:description: 'Connect Raindrop to automatically receive traces from your OpenRouter requests. Step-by-step setup guide for Raindrop integration.'
og:image: https://openrouter.ai/dynamic-og?title=Raindrop%20Broadcast&description=Send%20traces%20to%20Raindrop
og:image:width: 1200
og:image:height: 630
...
<img alt="Raindrop Event View" src="/assets/guides/features/broadcast/broadcast-raindrop-trace.png" />
