---
title: Webhook
description: Send traces to any HTTP endpoint
seoTitle: 'Broadcast to Webhook | OpenRouter Observability'
og:site_name: OpenRouter Documentation
og:title: 'Broadcast to Webhook - Send Traces to Any HTTP Endpoint'
og:description: 'Connect any HTTP endpoint to automatically receive traces from your OpenRouter requests. Step-by-step setup guide for Webhook integration.'
og:image: https://openrouter.ai/dynamic-og?title=Webhook%20Broadcast&description=Send%20traces%20to%20any%20HTTP%20endpoint
og:image:width: 1200
og:image:height: 630
