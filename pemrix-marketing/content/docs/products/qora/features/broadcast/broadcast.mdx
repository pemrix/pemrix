---
title: Broadcast
description: Send traces to external observability platforms
seoTitle: 'Broadcast | OpenRouter Observability'
og:site_name: OpenRouter Documentation
og:title: 'Broadcast - Send Traces to Observability Platforms'
og:description: 'Connect your LLM observability platforms to automatically receive traces from your OpenRouter requests. Supports Langfuse, Datadog, Braintrust, and more.'
og:image: https://openrouter.ai/dynamic-og?title=Broadcast&description=Send%20traces%20to%20observability%20platforms
og:image:width: 1200
og:image:height: 630
...
- [Google BigQuery](/guides/features/broadcast/bigquery)
...
- [Google BigQuery](/guides/features/broadcast/bigquery#custom-metadata) - Queryable via JSON functions
...
- [Google BigQuery](/guides/features/broadcast/bigquery) - Serverless cloud data warehouse
