...
seoTitle: 'Broadcast to LangSmith | OpenRouter Observability'
og:site_name: OpenRouter Documentation
og:title: 'Broadcast to LangSmith - Send Traces to LangSmith'
og:description: 'Connect LangSmith to automatically receive traces from your OpenRouter requests. Step-by-step setup guide for LangSmith integration.'
og:image: https://openrouter.ai/dynamic-og?title=LangSmith%20Broadcast&description=Send%20traces%20to%20LangSmith
og:image:width: 1200
og:image:height: 630
