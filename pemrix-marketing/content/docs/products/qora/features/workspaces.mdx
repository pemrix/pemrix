---
title: Workspaces
description: Organize your projects, teams, and agents into separate environments
seoTitle: 'Workspaces | OpenRouter Project & Team Management'
og:site_name: OpenRouter Documentation
og:title: 'Workspaces - Organize Projects, Teams, and Agents'
og:description: 'Separate your OpenRouter projects into independent environments, each with its own API keys, routing defaults, guardrails, and observability.'
og:image: https://openrouter.ai/dynamic-og?title=Workspaces&description=Organize%20projects%2C%20teams%2C%20and%20agents
og:image:width: 1200
og:image:height: 630
