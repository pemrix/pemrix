...
description: >-
  Move agent toolkit imports from @openrouter/sdk to the
  standalone @openrouter/agent package
seoTitle: >-
  Migrate to @openrouter/agent | OpenRouter SDK
  https://openrouter.ai/docs/sdks/agent-migration
og:site_name: OpenRouter Documentation
og:title: >-
  Migrate to @openrouter/agent | OpenRouter SDK
og:description: >-
  Step-by-step guide to migrating agent toolkit code from
  @openrouter/sdk to the new @openrouter/agent package.
og:image: >-
