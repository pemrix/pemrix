...
description: Common questions about OpenRouter
slug: faq
seoTitle: 'OpenRouter FAQ | Developer Documentation'
og:site_name: OpenRouter Documentation
og:title: 'OpenRouter FAQ'
og:description: "Find answers to commonly asked questions about OpenRouter's unified API, model access, pricing, and integration."
og:image: https://openrouter.ai/dynamic-og?pathname=faq&title=FAQ&description=Common%20questions%20about%20OpenRouter
og:image:width: 1200
og:image:height: 630
