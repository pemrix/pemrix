---
title: MCP
description: Connect your AI coding tools to OpenRouter over MCP
seoTitle: 'OpenRouter MCP Server | OpenRouter'
og:site_name: OpenRouter Documentation
og:title: 'OpenRouter MCP Server - OpenRouter'
og:description: 'Plug OpenRouter into the AI tools you already use. Pull live model, pricing, credit, and ranking data, search the docs, and send test messages, all from your editor.'
og:image: https://openrouter.ai/dynamic-og?title=OpenRouter%20MCP%20Server&description=Connect%20your%20AI%20tools%20to%20OpenRouter
og:image:width: 1200
og:image:height: 630
...
<Tabs>
  ...
  <Tab title="Claude Desktop / Web">
    ...
    1. Go to **Settings > Connectors > Customize > Connectors**, click the **+**, then choose **Add custom connector**.
       ...
       <img alt="Claude's Connectors page with the + menu open and Add custom connector highlighted" src="/assets/guides/overview/claude-connectors-menu.png" />
    ...
    3. Click **Add**, then open the connector and **Connect** to run the OAuth flow.
       ...
       <img alt="Claude's Add custom connector dialog with the Name set to OpenRouter MCP and the Remote MCP server URL set to https://mcp.openrouter.ai/mcp" src="/assets/guides/overview/claude-add-custom-connector.png" />
