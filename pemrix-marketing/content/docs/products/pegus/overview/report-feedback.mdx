...
seoTitle: 'Report Feedback | Submit Bug Reports on OpenRouter'
og:site_name: OpenRouter Documentation
og:title: 'Report Feedback - Submit Bug Reports for Generations'
og:description: 'Learn how to report issues with AI generations on OpenRouter using the Report Feedback feature in the Chatroom and Logs page.'
og:image: https://openrouter.ai/dynamic-og?title=Report%20Feedback&description=Submit%20bug%20reports%20for%20generations
og:image:width: 1200
og:image:height: 630
