---
title: Client SDKs
description: 'Lightweight, type-safe clients for the OpenRouter API'
seoTitle: Client SDKs | OpenRouter Documentation
'og:site_name': OpenRouter Documentation
'og:title': Client SDKs | OpenRouter
'og:description': >-
  Lightweight, type-safe SDK clients for calling AI models through OpenRouter.
  Available for TypeScript, Python, and Go.
'og:image': >-
  https://openrouter.ai/dynamic-og?pathname=client-sdks&title=Client%20SDKs&description=Lightweight%2C%20type-safe%20clients%20for%20the%20OpenRouter%20API
'og:image:width': 1200
'og:image:height': 630
