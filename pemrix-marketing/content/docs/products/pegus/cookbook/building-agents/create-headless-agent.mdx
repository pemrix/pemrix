---
title: Build Your Own Headless Agent
description: Scaffold a headless AI agent for CLI tools, API servers, and automation pipelines
seoTitle: 'Build Your Own Headless Agent | OpenRouter'
og:site_name: OpenRouter Documentation
og:title: 'Build Your Own Headless Agent - OpenRouter'
og:description: 'Use the create-headless-agent skill to scaffold a headless AI agent in TypeScript + Bun with configurable tools, output modes, and streaming via @openrouter/agent.'
og:image: https://openrouter.ai/dynamic-og?title=Build%20Your%20Own%20Headless%20Agent&description=Scaffold%20a%20headless%20AI%20agent%20for%20scripts%20and%20pipelines
og:image:width: 1200
og:image:height: 630
...
Once installed, ask your agent something like _"scaffold a headless agent"_ or _"build me a CLI agent"_ and the skill activates automatically.
