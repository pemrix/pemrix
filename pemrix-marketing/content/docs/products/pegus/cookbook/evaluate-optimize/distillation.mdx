---
title: Distillation
description: Ensure compliance with provider and model creator policies for distillation
seoTitle: 'Distillation | Compliance with Provider and Model Creator Policies'
og:site_name: OpenRouter Documentation
og:title: 'Distillation - Compliance with Provider and Model Creator Policies'
og:description: 'Learn how to use the distillable filter to ensure compliance with provider and model creator policies when using model outputs for training or distillation.'
og:image: https://openrouter.ai/dynamic-og?title=Distillation&description=Ensure%20compliance%20with%20provider%20and%20model%20creator%20policies
og:image:width: 1200
og:image:height: 630
