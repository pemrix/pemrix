---
title: Claude Opus 5 Migration Guide
description: Migrate to Claude Opus 5 — reasoning on by default, effort restrictions when disabling reasoning, and mid-conversation tool changes
seoTitle: 'Claude Opus 5 Migration Guide | OpenRouter'
og:site_name: OpenRouter Documentation
og:title: 'Claude Opus 5 Migration Guide'
og:description: 'Learn what changed in Claude Opus 5 — reasoning enabled by default, effort-level restrictions when disabling reasoning, and mid-conversation tool changes.'
og:image: https://openrouter.ai/dynamic-og?title=Claude%20Opus%205%20Migration%20Guide&description=Reasoning%20on%20by%20default%2C%20effort%20restrictions%2C%20and%20mid-conversation%20tool%20changes
og:image:width: 1200
og:image:height: 630
...
3. **Mid-conversation tool changes (beta)** — add and remove tools between turns without invalidating the prompt cache, via OpenRouter's [Messages API](/api/api-reference/anthropic-messages/create-a-message) only
...
See [Fast Mode](/cookbook/coding-agents/claude-code-integration#fast-mode) for details.
...
- [Fast Mode](/cookbook/coding-agents/claude-code-integration#fast-mode)
