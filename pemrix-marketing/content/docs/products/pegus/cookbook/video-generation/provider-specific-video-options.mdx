---
title: Use Provider-Specific Video Options
description: Inspect allowed passthrough parameters and send provider-specific video controls safely
seoTitle: 'Use Provider-Specific Video Options | OpenRouter Cookbook'
og:site_name: OpenRouter Documentation
og:title: 'Use Provider-Specific Video Options - OpenRouter Cookbook'
og:description: 'Use allowed_passthrough_parameters and provider.options to send model-specific video generation controls through OpenRouter.'
og:image: https://openrouter.ai/dynamic-og?title=Use%20Provider-Specific%20Video%20Options&description=Pass%20provider%20video%20options%20through%20OpenRouter
og:image:width: 1200
og:image:height: 630
