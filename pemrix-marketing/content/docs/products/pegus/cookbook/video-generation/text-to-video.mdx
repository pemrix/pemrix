...
description: Submit a text-to-video job, poll for completion, and save the generated MP4
seoTitle: 'Generate and Download a Video from Text | OpenRouter Cookbook'
og:site_name: OpenRouter Documentation
og:title: 'Generate and Download a Video from Text - OpenRouter Cookbook'
og:description: 'Submit an OpenRouter text-to-video generation job, poll the job status, and download the finished video file.'
og:image: https://openrouter.ai/dynamic-og?title=Generate%20and%20Download%20a%20Video%20from%20Text&description=Submit%2C%20poll%2C%20and%20save%20an%20OpenRouter%20video
og:image:width: 1200
og:image:height: 630
