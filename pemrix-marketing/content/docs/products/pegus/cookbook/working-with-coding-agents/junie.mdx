---
title: Junie CLI
description: Using OpenRouter with JetBrains Junie CLI
seoTitle: 'Junie CLI Integration | OpenRouter JetBrains Junie Support'
og:site_name: OpenRouter Documentation
og:title: 'Junie CLI Integration - OpenRouter JetBrains Support'
og:description: 'Integrate OpenRouter with JetBrains Junie CLI. Complete setup guide for using hundreds of AI models with the Junie agentic coding tool.'
og:image: https://openrouter.ai/dynamic-og?title=Junie%20CLI&description=JetBrains%20Junie%20Integration
og:image:width: 1200
og:image:height: 630
