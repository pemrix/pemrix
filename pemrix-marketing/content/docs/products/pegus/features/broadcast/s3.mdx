...
description: Send traces to Amazon S3 or S3-compatible storage
seoTitle: 'Broadcast to S3 | OpenRouter Observability'
og:site_name: OpenRouter Documentation
og:title: 'Broadcast to S3 - Send Traces to S3 Storage'
og:description: 'Connect Amazon S3 or S3-compatible storage to automatically receive traces from your OpenRouter requests. Step-by-step setup guide for S3 integration.'
og:image: https://openrouter.ai/dynamic-og?title=S3%20Broadcast&description=Send%20traces%20to%20S3%20storage
og:image:width: 1200
og:image:height: 630
