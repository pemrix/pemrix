---
title: Sentry
description: Send traces to Sentry
seoTitle: 'Broadcast to Sentry | OpenRouter Observability'
og:site_name: OpenRouter Documentation
og:title: 'Broadcast to Sentry - Send Traces to Sentry'
og:description: 'Connect Sentry to automatically receive traces from your OpenRouter requests. Step-by-step setup guide for Sentry integration.'
og:image: https://openrouter.ai/dynamic-og?title=Sentry%20Broadcast&description=Send%20traces%20to%20Sentry
og:image:width: 1200
og:image:height: 630
...
<Frame>
<img alt="Sentry Trace View" src="/assets/guides/features/broadcast/sentry/broadcast-sentry-trace.png" />
</Frame>
