...
description: Automatically categorize LLM generations in your workspace
seoTitle: 'Custom Classifiers | OpenRouter AI Usage Classification'
og:site_name: OpenRouter Documentation
og:title: 'Custom Classifiers - Automatic AI Usage Classification'
og:description: 'Define custom taxonomies and automatically classify every LLM generation by department, task type, complexity, or any dimension you choose.'
og:image: https://openrouter.ai/dynamic-og?title=Custom%20Classifiers&description=Automatic%20AI%20usage%20classification
og:image:width: 1200
og:image:height: 630
