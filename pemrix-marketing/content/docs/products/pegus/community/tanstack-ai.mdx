---
title: TanStack AI
description: Using OpenRouter with TanStack AI
seoTitle: 'TanStack AI Integration | OpenRouter SDK Support'
og:site_name: OpenRouter Documentation
og:title: 'TanStack AI Integration - OpenRouter SDK Support'
og:description: 'Integrate OpenRouter using TanStack AI. Complete guide for TanStack AI integration with OpenRouter for React, Solid, and Preact applications.'
og:image: https://openrouter.ai/dynamic-og?title=TanStack%20AI&description=TanStack%20AI%20Integration
og:image:width: 1200
og:image:height: 630
