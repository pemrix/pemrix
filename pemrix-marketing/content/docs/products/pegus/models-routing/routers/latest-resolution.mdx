---
title: Latest Model Resolution
description: Always target the newest version of a model family with a single slug
seoTitle: 'Latest Model Resolution | Stay on the Freshest Version Automatically'
og:site_name: OpenRouter Documentation
og:title: 'Latest Model Resolution - Always Target the Newest Version'
og:description: "Use ~author/family-latest slugs to automatically route to the newest model in a family on OpenRouter."
og:image: https://openrouter.ai/dynamic-og?title=Latest%20Model%20Resolution&description=Always%20target%20the%20newest%20version
og:image:width: 1200
og:image:height: 630
...
- [Model Variants](/guides/routing/model-variants/free) - `:free`, `:nitro`, and other suffixes
