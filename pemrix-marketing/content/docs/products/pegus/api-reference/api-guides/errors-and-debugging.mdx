...
description: API Errors and Debugging
seoTitle: 'API Error Handling and Debugging | OpenRouter Documentation'
og:site_name: OpenRouter Documentation
og:title: 'API Error Handling and Debugging - Complete Guide'
og:description: 'Learn how to handle errors and debug requests in OpenRouter API interactions. Comprehensive guide to error codes, messages, debugging options, and best practices.'
og:image: 'https://openrouter.ai/dynamic-og?title=API%20Error%20Handling%20and%20Debugging&description=Learn%20how%20to%20handle%20errors%20and%20debug%20requests%20in%20OpenRouter%20API%20interactions.'
og:image:width: 1200
og:image:height: 630
...
import { HTTPStatus } from "@/components/docs/snippets/exports/constants";
