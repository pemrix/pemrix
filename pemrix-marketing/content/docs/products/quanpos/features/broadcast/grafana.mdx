---
title: Grafana Cloud
description: Send traces to Grafana Cloud
seoTitle: 'Broadcast to Grafana Cloud | OpenRouter Observability'
og:site_name: OpenRouter Documentation
og:title: 'Broadcast to Grafana Cloud - Send Traces to Grafana Tempo'
og:description: 'Connect Grafana Cloud to automatically receive traces from your OpenRouter requests. Step-by-step setup guide for Grafana Cloud integration.'
og:image: https://openrouter.ai/dynamic-og?title=Grafana%20Cloud%20Broadcast&description=Send%20traces%20to%20Grafana%20Cloud
og:image:width: 1200
og:image:height: 630
...
<Frame>
<img alt="Grafana Cloud Configuration" src="/assets/guides/features/broadcast/grafana/broadcast-grafana-config.png" />
</Frame>
...
<Frame>
<img alt="Grafana Cloud Configured" src="/assets/guides/features/broadcast/grafana/broadcast-grafana-configured.png" />
</Frame>
...
<Frame>
<img alt="Grafana Cloud Trace" src="/assets/guides/features/broadcast/grafana/broadcast-grafana-trace.png" />
</Frame>
