---
title: Comet Opik
description: Send traces to Comet Opik
seoTitle: 'Broadcast to Comet Opik | OpenRouter Observability'
og:site_name: OpenRouter Documentation
og:title: 'Broadcast to Comet Opik - Send Traces to Opik'
og:description: 'Connect Comet Opik to automatically receive traces from your OpenRouter requests. Step-by-step setup guide for Opik integration.'
og:image: https://openrouter.ai/dynamic-og?title=Comet%20Opik%20Broadcast&description=Send%20traces%20to%20Comet%20Opik
og:image:width: 1200
og:image:height: 630
...
<Frame>
<img alt="Opik Trace View" src="/assets/guides/features/broadcast/opik/broadcast-opik-trace.png" />
</Frame>
