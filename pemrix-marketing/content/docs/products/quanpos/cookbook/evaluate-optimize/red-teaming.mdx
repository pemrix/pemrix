---
title: Red Teaming
description: Policy for red teaming and adversarial testing on OpenRouter
seoTitle: 'Red Teaming | Adversarial Testing Policy'
og:site_name: OpenRouter Documentation
og:title: 'Red Teaming - Adversarial Testing Policy'
og:description: 'Understand OpenRouter policies on red teaming, jailbreaking, and adversarial model testing. Learn how to get approval for legitimate security research.'
og:image: https://openrouter.ai/dynamic-og?title=Red%20Teaming&description=Adversarial%20testing%20policy%20and%20approval%20process
og:image:width: 1200
og:image:height: 630
