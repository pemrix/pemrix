---
title: Get Video Results with Webhooks
description: Submit a video job with a callback URL and verify OpenRouter webhook signatures
seoTitle: 'Get Video Results with Webhooks | OpenRouter Cookbook'
og:site_name: OpenRouter Documentation
og:title: 'Get Video Results with Webhooks - OpenRouter Cookbook'
og:description: 'Receive OpenRouter video job results through webhooks, preserve the raw request body, and verify the webhook signature.'
og:image: https://openrouter.ai/dynamic-og?title=Get%20Video%20Results%20with%20Webhooks&description=Receive%20OpenRouter%20video%20job%20callbacks
og:image:width: 1200
og:image:height: 630
