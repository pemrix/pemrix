---
title: Codex CLI
description: Use Codex CLI with OpenRouter
seoTitle: 'Integration with Codex CLI | OpenRouter'
og:site_name: OpenRouter Documentation
og:title: 'Codex CLI Integration - OpenRouter'
og:description: 'Learn how to configure Codex CLI to use OpenRouter for agentic coding with the latest GPT models and more.'
og:image: https://openrouter.ai/dynamic-og?title=Codex%20CLI&description=Use%20Codex%20CLI%20with%20OpenRouter
og:image:width: 1200
og:image:height: 630
