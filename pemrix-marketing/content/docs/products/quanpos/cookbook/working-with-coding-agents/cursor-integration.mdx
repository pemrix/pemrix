---
title: Cursor
description: Use Cursor with OpenRouter
seoTitle: 'Integration with Cursor | OpenRouter'
og:site_name: OpenRouter Documentation
og:title: 'Cursor Integration - OpenRouter'
og:description: 'Learn how to configure Cursor to use OpenRouter for access to hundreds of AI models through a single API key.'
og:image: https://openrouter.ai/dynamic-og?title=Cursor&description=Use%20Cursor%20with%20OpenRouter
og:image:width: 1200
og:image:height: 630
...
- Only models accessible via OpenRouter's [OpenAI-compatible endpoint](/api_reference/overview#openapi-specification) will work. Most chat and reasoning models are supported.
