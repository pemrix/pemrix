---
title: "Hermes Agent"
description: Use Hermes Agent by Nous Research with OpenRouter
seoTitle: 'Integration with Hermes Agent | OpenRouter'
og:site_name: OpenRouter Documentation
og:title: 'Hermes Agent Integration - OpenRouter'
og:description: 'Learn how to configure Hermes Agent to use OpenRouter for AI-powered coding, automation, and multi-platform messaging.'
og:image: https://openrouter.ai/dynamic-og?title=Hermes%20Agent&description=Use%20Hermes%20Agent%20with%20OpenRouter
og:image:width: 1200
og:image:height: 630
