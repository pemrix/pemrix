---
title: Adding a Tax ID to Your Invoices
description: How to add your VAT, GST, or other tax ID so it appears on OpenRouter invoices
slug: tax-id
seoTitle: 'Add VAT / Tax ID to OpenRouter Invoices'
og:site_name: OpenRouter Documentation
og:title: 'Add VAT / Tax ID to OpenRouter Invoices'
og:description: 'Step-by-step guide to adding your VAT number, GST, EIN, or other tax ID to your OpenRouter invoices.'
og:image: https://openrouter.ai/dynamic-og?pathname=tax-id&title=Tax%20ID&description=Add%20your%20VAT%20or%20tax%20ID%20to%20invoices
og:image:width: 1200
og:image:height: 630
