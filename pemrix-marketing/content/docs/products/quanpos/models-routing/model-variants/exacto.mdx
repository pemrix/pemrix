...
og:image: https://openrouter.ai/dynamic-og?title=Exacto%20Variant&description=Quality-first%20provider%20routing
og:image:width: 1200
og:image:height: 630
...
- Benchmark data from OpenRouter's benchmark harness (see [What the Benchmark Harness Runs](/guides/routing/auto-exacto#what-the-benchmark-harness-runs) for the benchmarks and parameters, and [Where to Find the Scores](/guides/routing/auto-exacto#where-to-find-the-scores) for the published results)
