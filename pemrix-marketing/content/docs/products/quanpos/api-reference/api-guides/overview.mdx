---
title: API Reference
description: An overview of OpenRouter's API
seoTitle: 'OpenRouter API Reference | Complete API Documentation'
...
og:image: https://openrouter.ai/dynamic-og?title=OpenRouter%20API%20Reference&description=Comprehensive%20guide%20to%20OpenRouter's%20API.
og:image:width: 1200
og:image:height: 630
...
```typescript title="Request Schema" expandable lines
...
**Model routing**
  ...
  models](/guides/overview/models) or [API](/api/api-reference/models/list-all-models-and-their-properties), and include the organization
...
```typescript title="Query Generation Stats" lines
