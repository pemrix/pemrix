...
seoTitle: 'API Authentication | OpenRouter OAuth and API Keys'
...
og:image: https://openrouter.ai/dynamic-og?title=API%20Authentication&description=Secure%20access%20to%20OpenRouter
og:image:width: 1200
og:image:height: 630
