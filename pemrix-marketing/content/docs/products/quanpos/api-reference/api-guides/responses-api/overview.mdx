...
seoTitle: 'OpenRouter Responses API'
og:site_name: OpenRouter Documentation
og:title: 'OpenRouter Responses API - OpenAI-Compatible Documentation'
og:description: "OpenRouter's OpenAI-compatible Responses API. Stateless transformation layer with support for reasoning, tool calling, and web search."
og:image: https://openrouter.ai/dynamic-og?title=Responses%20API&description=OpenAI-compatible%20stateless%20API
og:image:width: 1200
og:image:height: 630
