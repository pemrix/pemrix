...
seoTitle: 'Embeddings API | Convert Text and Images to Vector Representations with OpenRouter'
og:site_name: OpenRouter Documentation
og:title: 'Embeddings API - Generate Vector Embeddings from Text and Images'
og:description: "Generate vector embeddings from text and images using OpenRouter's unified embeddings API. Access multiple embedding models from different providers with a single interface."
og:image: https://openrouter.ai/dynamic-og?title=Embeddings%20API&description=Generate%20Vector%20Embeddings%20from%20Text%20and%20Images
og:image:width: 1200
og:image:height: 630
