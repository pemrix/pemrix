---
title: Replit
description: Using OpenRouter with Replit Agent and Replit Apps
seoTitle: 'Replit Integration | Add OpenRouter API Key to Replit'
og:site_name: OpenRouter Documentation
og:title: 'Replit Integration - Add OpenRouter API Key to Replit'
og:description: 'Add your OpenRouter API key to Replit to access 400+ AI models in Replit Agent and your Replit apps. Covers BYOK setup and project Secrets.'
og:image: https://openrouter.ai/dynamic-og?title=Replit&description=Add%20OpenRouter%20API%20Key%20to%20Replit
og:image:width: 1200
og:image:height: 630
