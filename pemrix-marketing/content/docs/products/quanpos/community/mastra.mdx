---
title: Mastra
description: Using OpenRouter with Mastra
seoTitle: 'Mastra Integration | OpenRouter SDK Support'
og:site_name: OpenRouter Documentation
og:title: 'Mastra Integration - OpenRouter SDK Support'
og:description: 'Integrate OpenRouter using Mastra framework. Complete guide for Mastra integration with OpenRouter for unified AI model access.'
og:image: https://openrouter.ai/dynamic-og?title=Mastra&description=Mastra%20Integration
og:image:width: 1200
og:image:height: 630
