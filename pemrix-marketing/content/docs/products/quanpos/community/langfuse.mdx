---
title: Langfuse
description: Using OpenRouter with Langfuse
seoTitle: 'Langfuse Integration | OpenRouter SDK Support'
og:site_name: OpenRouter Documentation
og:title: 'Langfuse Integration - OpenRouter SDK Support'
og:description: 'Integrate OpenRouter using Langfuse for observability and tracing. Complete guide for Langfuse integration with OpenRouter for Python applications.'
og:image: https://openrouter.ai/dynamic-og?title=Langfuse&description=Langfuse%20Integration
og:image:width: 1200
og:image:height: 630
