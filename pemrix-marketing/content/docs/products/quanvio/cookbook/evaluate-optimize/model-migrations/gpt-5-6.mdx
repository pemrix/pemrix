---
title: GPT-5.6 Migration Guide
description: Adopt reasoning.mode, reasoning.context, and explicit prompt caching for the GPT-5.6 model family
seoTitle: "GPT-5.6 Migration Guide | OpenRouter"
og:site_name: OpenRouter Documentation
og:title: "GPT-5.6 Migration Guide"
og:description: >-
  Learn how to use reasoning.mode, reasoning.context, and explicit
  prompt caching with GPT-5.6 Sol, Terra, and Luna on OpenRouter.
og:image: https://openrouter.ai/dynamic-og?title=GPT-5.6%20Migration%20Guide&description=reasoning.mode%2C%20reasoning.context%2C%20and%20explicit%20prompt%20caching%20for%20GPT-5.6
og:image:width: 1200
og:image:height: 630
