---
title: OpenCode
description: Use OpenCode with OpenRouter
seoTitle: 'Integration with OpenCode | OpenRouter'
og:site_name: OpenRouter Documentation
og:title: 'OpenCode Integration - OpenRouter'
og:description: 'Learn how to configure the OpenCode terminal and desktop apps to use OpenRouter for agentic coding with access to hundreds of AI models.'
og:image: https://openrouter.ai/dynamic-og?title=OpenCode&description=Use%20OpenCode%20with%20OpenRouter
og:image:width: 1200
og:image:height: 630
