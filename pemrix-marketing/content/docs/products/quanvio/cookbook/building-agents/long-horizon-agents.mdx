---
title: Build a Long-Horizon Agent
description: Run multi-hour agent loops with cost ceilings, resumable state, and voice input
seoTitle: 'Build a Long-Horizon Agent | OpenRouter Cookbook'
og:site_name: OpenRouter Documentation
og:title: 'Build a Long-Horizon Agent on OpenRouter'
og:description: 'Run agents for hours, not seconds. Cap cost and step count, persist state for resumability, stream progress, and drive the same loop from voice input.'
og:image: https://openrouter.ai/dynamic-og?title=Long-Horizon%20Agents&description=Multi-hour%20agent%20loops%20with%20cost%20ceilings%2C%20resumable%20state%2C%20and%20voice%20input
og:image:width: 1200
og:image:height: 630
