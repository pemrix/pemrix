---
title: Add Human-in-the-Loop Controls to an Agent SDK Agent
description: Add HITL to an existing Agent SDK agent so it can pause high-stakes tool calls for human input
seoTitle: 'Add Human-in-the-Loop Controls to an Agent SDK Agent | OpenRouter Cookbook'
og:site_name: OpenRouter Documentation
og:title: 'Add Human-in-the-Loop Controls to an Agent SDK Agent'
og:description: 'Add HITL controls to an existing OpenRouter Agent SDK agent so routine tool calls resolve automatically and high-stakes decisions pause for human review.'
og:image: https://openrouter.ai/dynamic-og?title=Human-in-the-Loop%20Controls&description=Auto-resolve%20or%20pause%20for%20human%20review
og:image:width: 1200
og:image:height: 630
