---
title: Migrating to @openrouter/agent
description: >-
  Move agent toolkit imports from @openrouter/sdk to the standalone
  @openrouter/agent package
seoTitle: Migrate to @openrouter/agent | OpenRouter SDK
'og:site_name': OpenRouter Documentation
'og:title': Migrate to @openrouter/agent | OpenRouter SDK
'og:description': >-
  Step-by-step guide to migrating agent toolkit code from @openrouter/sdk to the
  new @openrouter/agent package.
'og:image': >-
  https://openrouter.ai/dynamic-og?title=Agent%20Migration&description=Migrate%20to%20%40openrouter%2Fagent
'og:image:width': 1200
'og:image:height': 630
