...
description: Observe and control the agent loop with typed lifecycle hooks.
seoTitle: 'Lifecycle Hooks | OpenRouter Agent SDK'
og:site_name: OpenRouter Documentation
og:title: 'Lifecycle Hooks - OpenRouter Agent SDK'
og:description: >-
  Observe tools, intercept prompts, control approvals, and collect telemetry
  with typed Agent SDK lifecycle hooks.
og:image: >-
  https://openrouter.ai/dynamic-og?title=Hooks&description=Agent%20events
og:image:width: 1200
og:image:height: 630
...
- **[Tools](/agent-sdk/call-model/tools)** - Define and execute typed tools
- **[Tool Approval & State](/agent-sdk/call-model/tool-approval-state)** -
  Pause and resume approval-gated tools
- **[Stop Conditions](/agent-sdk/call-model/stop-conditions)** - Control when
  the agent loop ends
- **[API Reference](/agent-sdk/call-model/api-reference)** - Review complete
