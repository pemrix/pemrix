...
description: Add OpenRouter Agent SDK skills to your AI coding assistant
seoTitle: Usage for Agents | OpenRouter Agent SDK
'og:site_name': OpenRouter Documentation
'og:title': Usage for Agents | OpenRouter Agent SDK
'og:description': >-
  Add OpenRouter Agent SDK skills to AI coding assistants like Claude Code,
  Cursor, GitHub Copilot, and more. Enable your AI to code with the OpenRouter
  Agent SDK.
'og:image': >-
  https://openrouter.ai/dynamic-og?title=Usage%20for%20Agents&description=Add%20OpenRouter%20Agent%20SDK%20skills%20to%20your%20AI%20coding%20assistant
'og:image:width': 1200
'og:image:height': 630
