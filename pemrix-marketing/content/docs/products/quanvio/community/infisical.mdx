...
seoTitle: 'Infisical Integration | OpenRouter API Key Management'
og:site_name: OpenRouter Documentation
og:title: 'Infisical Integration - OpenRouter API Key Management'
og:description: 'Set up automatic API key rotation for OpenRouter using Infisical. Complete guide for secure key management and zero-downtime rotation.'
og:image: https://openrouter.ai/dynamic-og?title=Infisical&description=Automatic%20API%20Key%20Rotation
og:image:width: 1200
og:image:height: 630
...
<Frame>
<img alt="OpenRouter Management Keys page showing the Create Management Key button" src="/assets/guides/community/infisical/infisical-provisioning-keys.png" />
</Frame>
...
<Frame>
<img alt="Infisical dashboard showing the Add Secret Rotation option" src="/assets/guides/community/infisical/infisical-add-rotation.png" />
</Frame>
...
For more details, see [OpenRouter BYOK documentation](/guides/overview/auth/byok) and [OpenRouter limits documentation](/api_reference/limits).
