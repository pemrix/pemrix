...
description: Get your app featured in OpenRouter rankings and analytics
slug: app-attribution
seoTitle: 'App Attribution | OpenRouter Documentation'
og:site_name: OpenRouter Documentation
og:title: 'App Attribution'
og:description: "Learn how to attribute your API usage to your app and appear in OpenRouter's app rankings and model analytics."
og:image: https://openrouter.ai/dynamic-og?pathname=app-attribution&title=App%20Attribution&description=Get%20your%20app%20featured%20in%20rankings
og:image:width: 1200
og:image:height: 630
...
```python title="Python (Direct API)" expandable lines
import requests
import json
...
- [Quickstart Guide](/quickstart) - Basic setup with attribution headers
- [API Reference](/api_reference/overview) - Complete header documentation
- [Usage Accounting](/cookbook/administration/usage-accounting) - Understanding your API usage
