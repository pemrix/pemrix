...
description: Send traces to any OpenTelemetry-compatible backend
seoTitle: 'Broadcast to OpenTelemetry Collector | OpenRouter Observability'
og:site_name: OpenRouter Documentation
og:title: 'Broadcast to OpenTelemetry Collector - Send Traces to OTLP Backends'
og:description: 'Connect any OpenTelemetry-compatible backend to automatically receive traces from your OpenRouter requests. Step-by-step setup guide for OTLP integration.'
og:image: https://openrouter.ai/dynamic-og?title=OpenTelemetry%20Collector%20Broadcast&description=Send%20traces%20to%20OTLP%20backends
og:image:width: 1200
og:image:height: 630
