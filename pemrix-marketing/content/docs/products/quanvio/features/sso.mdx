...
description: Let your team sign in to OpenRouter through your identity provider
seoTitle: 'OpenRouter Single Sign-On (SSO) | Developer Documentation'
og:site_name: OpenRouter Documentation
og:title: 'OpenRouter Single Sign-On (SSO)'
og:description: 'Set up SAML single sign-on for your OpenRouter organization with Okta, Microsoft Entra ID, Google Workspace, or a custom SAML identity provider.'
og:image: https://openrouter.ai/dynamic-og?pathname=guides/features/sso&title=Single%20Sign-On&description=Sign%20in%20through%20your%20identity%20provider
og:image:width: 1200
og:image:height: 630
...
With an SSO connection in place, you can also sync groups from your identity provider and map them to OpenRouter workspaces, so workspace access is provisioned automatically. See [SCIM Group Mappings](/guides/features/scim-mappings).
