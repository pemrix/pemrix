---
title: Notifications
description: Choose which OpenRouter alerts you receive and where they are delivered
seoTitle: "Notifications | OpenRouter Alerts and Delivery Settings"
og:site_name: OpenRouter Documentation
og:title: "Notifications - Choose Your OpenRouter Alerts"
og:description: "Turn on low balance, model deprecation, workspace budget, and API key spend alerts, set the amounts that trigger them, and choose who receives them by email, Slack, or your own webhook endpoint."
og:image: https://openrouter.ai/dynamic-og?title=Notifications&description=Choose%20which%20OpenRouter%20alerts%20you%20receive
og:image:width: 1200
og:image:height: 630
