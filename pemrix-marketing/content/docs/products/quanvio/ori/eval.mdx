---
title: Ori Eval
description: Find the best model for your project by testing your agent on real prompts, with one harness and one model for each run
seoTitle: 'Ori Eval | Find the Best Model for Your Project'
og:site_name: OpenRouter Documentation
og:title: 'Ori Eval - Find the Best Model for Your Project'
...
og:image: https://openrouter.ai/dynamic-og?title=Ori%20Eval&description=Find%20the%20best%20model%20for%20your%20project
og:image:width: 1200
og:image:height: 630
