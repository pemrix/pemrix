...
description: Find the files and directories that Ori creates during a run
seoTitle: "Where Ori writes files | OpenRouter Documentation"
og:site_name: OpenRouter Documentation
og:title: "Where Ori writes files"
og:description: "Find the files and directories that Ori creates during a run."
nofollow: false
icon: folder
---
