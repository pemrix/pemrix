---
title: Containers
description: How sandbox containers work for the shell and bash server tools
seoTitle: 'Containers | Sandbox Containers for Server Tools'
og:site_name: OpenRouter Documentation
og:title: 'Containers - Sandbox Containers for Server Tools'
og:description: 'How OpenRouter sandbox containers work: container ids, reuse, lifetime, file persistence, attached workspace files, and file downloads.'
og:image: https://openrouter.ai/dynamic-og?title=Containers&description=Sandbox%20containers%20for%20server%20tools
og:image:width: 1200
og:image:height: 630
...
[shell](/guides/features/server-tools/shell) and
[bash](/guides/features/server-tools/bash) server tools run their commands
...
[Files API](/guides/features/files-api). Then pass their ids in the
...
[Files API](/guides/features/files-api) shape, with a new `or_file_` id. You
...
[shell network policy](/guides/features/server-tools/shell#network-policy)
and [bash network policy](/guides/features/server-tools/bash#network-policy)
sections.
...
- [Shell](/guides/features/server-tools/shell): The shell server tool
- [Bash](/guides/features/server-tools/bash): The bash server tool
- [Files API](/guides/features/files-api): Upload files to your workspace
