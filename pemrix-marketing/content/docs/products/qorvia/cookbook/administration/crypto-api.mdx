---
title: Crypto API
description: Coinbase Commerce API deprecation
seoTitle: 'Crypto API | Deprecated Coinbase Commerce Endpoint'
og:site_name: OpenRouter Documentation
og:title: 'Crypto API - Deprecated Coinbase Commerce Endpoint'
og:description: 'Coinbase deprecated the APIs used by the legacy Coinbase Commerce crypto credits endpoint, which now returns 410 Gone.'
og:image: https://openrouter.ai/dynamic-og?title=Crypto%20API&description=Deprecated%20Coinbase%20Commerce%20Endpoint
og:image:width: 1200
og:image:height: 630
