---
title: Data API
seoTitle: 'Data API | Rankings, Benchmarks, App Analytics, and Task Classifications'
og:site_name: OpenRouter Documentation
og:title: 'Data API - Rankings, Benchmarks, App Analytics, and Task Classifications'
og:description: 'Access model rankings, benchmark data, app analytics, and task classification market share from the OpenRouter Data API. Fetch daily model token totals, top apps by usage or growth, and traffic breakdowns by task type, all gated by your regular API key.'
og:image: https://openrouter.ai/dynamic-og?title=Data%20API&description=Rankings%2C%20benchmarks%2C%20app%20analytics%2C%20and%20task%20classifications%20as%20JSON
og:image:width: 1200
og:image:height: 630
