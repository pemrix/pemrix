...
description: Privately store and review your prompts and completions
seoTitle: 'Input & Output Logging | OpenRouter Observability'
og:site_name: OpenRouter Documentation
og:title: 'Input & Output Logging - Privately Store Prompts and Completions'
og:description: 'Store your prompts and completions privately on OpenRouter for debugging, evaluation, and optimization. View them in your Logs page.'
og:image: https://openrouter.ai/dynamic-og?title=Input%20%26%20Output%20Logging&description=Privately%20store%20and%20review%20prompts
og:image:width: 1200
og:image:height: 630
...
nofollow: false
icon: file-lines
sidebarTitle: Input & Output Logging
---
