---
title: Detected Secret Formats
description: Full list of API key and credential formats detected by the Secrets guardrail preset
seoTitle: 'Detected Secret Formats | OpenRouter Guardrails'
og:site_name: OpenRouter Documentation
og:title: 'Detected Secret Formats - Secrets Guardrail Preset Reference'
og:description: 'Reference list of every well-known API key and credential format detected by the OpenRouter Secrets guardrail preset.'
og:image: https://openrouter.ai/dynamic-og?title=Detected%20Secret%20Formats&description=Secrets%20guardrail%20preset%20reference
og:image:width: 1200
og:image:height: 630
...
nofollow: false
icon: key
sidebarTitle: Secret Formats
---

This page lists every format detected by the **Secrets** preset of the [Sensitive Info Guardrail](/guides/features/guardrails/sensitive-info). The preset focuses on recognizable vendor prefixes and structures rather than generic high-entropy values.
...
The Secrets preset does not use entropy-only detection, bare unprefixed 32-character hexadecimal patterns, UUIDs, or generic hashes. Custom formats without a recognizable supported structure require a [custom pattern](/guides/features/guardrails/sensitive-info#custom-patterns).
