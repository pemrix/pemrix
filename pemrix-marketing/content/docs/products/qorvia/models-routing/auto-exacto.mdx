---
title: Auto Exacto
description: Automatic tool-calling provider optimization
seoTitle: "Auto Exacto | Smarter provider routing for tool-calling requests"
og:site_name: OpenRouter Documentation
og:title: "Auto Exacto - Automatic tool-calling provider optimization"
og:description: "Learn how Auto Exacto automatically optimizes provider ordering for tool-calling requests using throughput, success rate, and benchmark signals."
og:image: https://openrouter.ai/dynamic-og?title=Auto%20Exacto&description=Automatic%20tool-calling%20provider%20optimization
og:image:width: 1200
og:image:height: 630
