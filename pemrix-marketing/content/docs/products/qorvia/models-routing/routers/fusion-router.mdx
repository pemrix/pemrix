---
title: Fusion Router
description: Multi-model deliberation as a model slug
seoTitle: 'Fusion Router | Multi-model AI Deliberation with OpenRouter'
og:site_name: OpenRouter Documentation
og:title: 'Fusion Router - openrouter/fusion'
og:description: "Use the openrouter/fusion model slug to access multi-model deliberation (a panel of models, an analyst, and a final answer) in a single API call."
og:image: https://openrouter.ai/dynamic-og?title=Fusion%20Router&description=Multi-model%20deliberation%20as%20a%20model%20slug
og:image:width: 1200
og:image:height: 630
...
```json title="Model alias (tool auto-injected)" lines
{
...
```json title="Server tool (explicit)" lines
{
