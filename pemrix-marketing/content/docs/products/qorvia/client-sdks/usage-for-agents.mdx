---
title: Usage for Agents
description: Add OpenRouter Client SDKs skills to your AI coding assistant
seoTitle: Usage for Agents | OpenRouter Client SDKs
'og:site_name': OpenRouter Documentation
'og:title': Usage for Agents | OpenRouter Client SDKs
'og:description': >-
  Add OpenRouter Client SDKs skills to AI coding assistants like Claude Code,
  Cursor, GitHub Copilot, and more. Enable your AI to code with the OpenRouter
  Client SDKs.
'og:image': >-
  https://openrouter.ai/dynamic-og?pathname=client-sdks/usage-for-agents&title=Usage%20for%20Agents&description=Add%20OpenRouter%20Client%20SDKs%20skills%20to%20your%20AI%20coding%20assistant
'og:image:width': 1200
'og:image:height': 630
